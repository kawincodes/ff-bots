...
# Bot token
BOT_TOKEN = "6975298687:AAHLeKtiM19LFzB6Tf9aV9djloepVwd3x1E"

# Allowed user ID (replace with the correct user ID)
ALLOWED_USER_ID = [7318766583, 6667256453, 6095233308]
...
async def filter_channel_posts(update: Update, context: CallbackContext):
    ...
    if update.channel_post:
        ...
        # If the user is not allowed, delete the message immediately
        ...
        # Wait 30 seconds before deleting the message if it's not from the allowed user
        if user_id != ALLOWED_USER_ID:
